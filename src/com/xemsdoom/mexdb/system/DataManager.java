...
/**
 * Copyright (C) 2012-2013 MexProjects
 * [XemsDoom (Luca Moser) & FrozenBrain (Carsten Schneider)]
 * 
...
public class DataManager{
    ...
    public boolean removeValue(String index, String key) {
        ...
        LinkedHashMap<String, String> argsmap = getKeySetRaw(index.toLowerCase());
    ...
    public void setValue(String index, String key, Object value) {
        ...
        // Getting a keyset
        LinkedHashMap<String, String> args = getKeySetRaw(index.toLowerCase());
    ...
    public ArrayList<String> getValues(String index) {
        ...
        LinkedHashMap<String, String> keyset = getKeySetRaw(index.toLowerCase());
     ...
     */
    private LinkedHashMap<String, String> getKeySetRaw(String index) {
    ...
    public LinkedHashMap<String, String> getKeySet(String index) {
        ...
        for(int counter = 0; counter < seg.length; counter++){
            ...
            if(shorterseg.length == 0)
                continue;
            argsmap.put(shorterseg[0], shorterseg.length == 2 ? encode(shorterseg[1]) : null);
    ...
    public boolean hasKey(String index, String key) {
        ...
        LinkedHashMap<String, String> keyset = getSharpKeySet(index.toLowerCase().trim(), key.toLowerCase().trim());

        if(keyset.isEmpty())
            return false;

        if(keyset.containsKey(key.toLowerCase().trim()))
            return true;
        else
            return false;
    }
